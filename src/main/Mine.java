...
public class Mine {
	...
	public static void main(String[] args){
		...
		String path = "F:/Study/Research/GraphModelForArgumentRecommendation/eclipse.jdt.core-master/eclipse.jdt.core-master", name = "itext";
//		String path = "input/Test2.java", name = "";
//		String path = "test/input/Test_mine.java", name = "";
		EGroumBuilder gb = new EGroumBuilder(new AUGConfiguration(){{groum = false; minStatements = 2;}});

		Miner miner = new Miner(name, new Configuration(){{minPatternSupport = 10;}});
		miner.mineGM(gb.buildBatch(path, null));
		miner.printFile();
